...
public class VaultFilterChainProxy extends GenericFilterBean {
	protected final Logger logger = LogManager.getLogger(this.getClass());

	protected final static String FILTER_APPLIED = FilterChainProxy.class.getName().concat(".APPLIED");
	protected List<VaultFilterChain> filterChains = Lists.newArrayList();
	...
	private List<Filter> getFilters(HttpServletRequest request) {
		...
		for (VaultFilterChain chain : filterChains) {
	...
	public List<VaultFilterChain> getFilterChains() {
	...
	public interface FilterChainValidator {
		void validate(VaultFilterChainProxy filterChainProxy);
	}

	private class NullFilterChainValidator implements FilterChainValidator {
		@Override
		public void validate(VaultFilterChainProxy filterChainProxy) {
			// No op
		}
	}
}