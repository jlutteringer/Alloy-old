...
public class LocalDateTimeUserType implements UserType, Serializable {
	private static final long serialVersionUID = -522520819914054352L;
	...
	public void nullSafeSet(PreparedStatement preparedStatement, Object value, int index, SessionImplementor session)
		...
		if (value == null) {
			...
			Date timestamp = _Date.toDate(ldt);
